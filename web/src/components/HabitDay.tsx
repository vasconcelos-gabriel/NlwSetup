...
const HabitDay = ({ defaultCompleted = 0, amount = 0, date }: HabitDayProps) => {
  ...
  return (
    <Popover.Root>
      ...
      <Popover.Portal>
        <Popover.Content className="min-w-[320] p-6 rounded-2xl bg-zinc-900 flex flex-col transition-colors focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-background">
